...
import org.saipal.workforce.admistr.service.HealthOfficeService;
...
@RestController
@RequestMapping("health-office")
public class HealthOfficeController {

	@Autowired
	ValidationService validationService;
	
	@Autowired
	HealthOfficeService objService;
	
	@PostMapping("")
	public ResponseEntity<Map<String, Object>> store(HttpServletRequest request) {
		Validator validator = validationService.validate(HealthOffice.rules());

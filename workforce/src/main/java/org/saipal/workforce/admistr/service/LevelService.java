...
import org.saipal.workforce.admistr.model.Level;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.ResponseEntity;
import org.springframework.stereotype.Component;

@Component
public class LevelService extends AutoService {
	...
	private String table = "tbl_level";
	
	public ResponseEntity<Map<String, Object>> index() {
		String condition = "";
		if (!request("searchTerm").isEmpty()) {
			List<String> searchbles = Level.searchables();
			condition += "and (";
	...
	public ResponseEntity<Map<String, Object>> store() {
		...
		sql = "INSERT INTO tbl_level (nameen,namenp,status,created_by) VALUES (?,?,?,?)";
	...
	public ResponseEntity<Map<String, Object>> update(String id) {
		...
		String sql = "UPDATE tbl_level set nameen=?,namenp=?,status=? where id=?";
	...
	public ResponseEntity<Map<String, Object>> destroy(String id) {
		...
		String sql = "delete from tbl_level where id  = ?";

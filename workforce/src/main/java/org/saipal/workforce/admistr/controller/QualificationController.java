...
import org.saipal.workforce.admistr.service.QualificationService;
...
public class QualificationController {
	...
	@Autowired
	QualificationService objService;
	
	@PostMapping("")
	public ResponseEntity<Map<String, Object>> store(HttpServletRequest request) {
		System.out.println("here");
		Validator validator = validationService.validate(Qualification.rules());

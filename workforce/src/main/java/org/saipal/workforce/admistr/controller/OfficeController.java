...
public class OfficeController {
	...
	public ResponseEntity<Map<String, Object>> removeEmp(HttpServletRequest request,@PathVariable String id) {
		
		return objService.removeEmp(id);
	}
	
	@GetMapping("/removePost")
	public ResponseEntity<Map<String, Object>> removePost(HttpServletRequest request) {
		
		return objService.removePost();
	}

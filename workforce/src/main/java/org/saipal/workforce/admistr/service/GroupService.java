...
@Component
public class GroupService extends AutoService {
	...
	private String table = "tbl_samuha";
	
	public ResponseEntity<Map<String, Object>> index() {
		String condition = "";
		if (!request("searchTerm").isEmpty()) {
			List<String> searchbles = Group.searchables();
			condition += "and (";
	...
	public ResponseEntity<Map<String, Object>> update(String id) {
		...
		String sql = "UPDATE tbl_samuha set nameen=?,namenp=?,status=? where id=?";
	...
	public ResponseEntity<Map<String, Object>> destroy(String id) {
		...
		String sql = "delete from tbl_samuha where id  = ?";

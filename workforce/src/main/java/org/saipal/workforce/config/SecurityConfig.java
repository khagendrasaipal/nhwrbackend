...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	String[] excludeResource = { "/favicon.ico", "/sw.js", "/ng-login", "/error", "/util/**", "/check-login","/sign-in",
			...
			"/ribbon/**", "/sjs/**", "/apphome/js/dhtmlx/**", "/wrtc-signal","/registry/pivotview","/registry/pivotexcel","/registry/getData2","/get-auth-token","/calender/**","/test/**","test/authorize","/test/dashboard","/test/web","/Emblem_of_Nepal_2020.svg","/getDashboard","/registry/downloadcsv","/registry/downloadreport","/registry/downloadreport2","/registry/getData"};
